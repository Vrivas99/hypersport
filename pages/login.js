    ...
    <div className="flex flex-col md:flex-row items-center align-middle">
      ...
      <div className=" bg-white items-center justify-center h-screen flex flex-col md:mx-auto md:max-0 md:max-w-md lg:max-w-full w-full md:w-1/2 xl:w-1/3 px-6 lg:px-16 xl:px-12">
        <div className="relative w-full h-auto">
          <Link
            href="/"
            className="absolute -top-10 -left-2 cursor-pointer m-2 rounded-xl bg-purple-600 p-3 hover:bg-purple-800"
          >
            <p className=" text-white font-bold">volver</p>
          </Link>
          <h1 className="text-xl md:text-2x1  font-bold leanding-tight mt-12">
          ...
          <form onSubmit={handleSumbit} className="mt-3">
            ...
            <button
              className="w-full block bg-purple-500 hover:bg-purple-400 px-4 py-3 mt-6 rounded-lg font-semibold text-white focus:bg-purple-400"
              type="submit"
              href="/"
            >
              Ingresar
