                ...
                <div className="relative overflow-x-auto sm:rounded-xl">
                    <div className="pb-4 bg-gray-900">
                        ...
                        <div className="relative mt-1">
                            ...
                            <Link href='/agregarusuario' className='text-center float-right bg-green-600 align-middle hover:bg-green-900 text-white px-6 py-2 rounded-xl font-sans'>Ingresar</Link>
                    ...
                    <div className='relative overflow-x-auto sm:rounded-xl'>
                        <table className='w-full pl-10 text-sm text-left text-gray-500 dark:text-gray-400'>
                            <thead className='text-xs text-gray-700 uppercase bg-gray-700 dark:text-gray-400'>
                                <tr>
                                    <th scope='col' className='text-white px-4 py-3 text-center'>ID</th>
                                    <th scope='col' className='text-white px-4 py-3 text-center'>CORREO</th>
                                    <th scope='col' className='text-white px-4 py-3 text-center'>CONTRASEÑA</th>
                                    <th scope='col' className='text-white px-4 py-3 text-center'>OPCIONES</th>
                                </tr>
                            </thead>
                            <tbody>
                            {/* aqui se deberia recorrer la base de datos */}
                                <tr className='border-b bg-gray-900 border-gray-700 hover:bg-gray-700 hover:text-white'>
                                    <td scope='row' className='px-4 py-2 font-medium text-white text-center'>5</td>
                                    <td scope='row' className='px-4 py-2 font-medium text-white text-center'>marc.contreras@duocuc.cl</td>
                                    <td scope='row' className='px-4 py-2 font-medium text-white text-center'>Holaola2021+-</td>
                                    <td scope='row' className='px-4 py-2 font-medium text-white text-center'>
                                        ...
                                        <Link href='#' className='cursor-pointer p-1 font-medium text-red-500 hover:underline'>ELIMINAR</Link>
                                    </td>
                                </tr>
