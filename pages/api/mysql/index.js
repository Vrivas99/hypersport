...
const recuperarProducto = async (req, res) => {
  const [result] = await pool.query(
    "SELECT t1.id,t1.title,t2.nombre as categoria,t1.Descu,t1.descripcion,t1.price,t1.cantidad,t1.originalPrice,t1.img,t1.idcategoria,t1.marca from PRODUCTO as t1 JOIN CATEGORIA as t2 on t1.idcategoria = t2.id where t1.title IS NOT NULL AND t1.id > 6"
  );
...
const guardarProducto = async (req, res) => {
  ...
  const { nombre, img, descu, descri, prices, cantidad, marca, categoria } =
    req.body;
