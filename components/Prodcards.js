...
export default function CardComponent() {
    const posts = [
        {
            title: "ZAPATILLA NIKE REVOLUTION 6aa",
    ...
    return (
        <>
            <div className="p-10 -z-50 grid justify-items-center sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-5">
                {posts.map((items, key) => (
                    <div className="relative flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md" key={key}>
                        <a className="relative mx-3 mt-3 flex h-60 overflow-hidden rounded-xl" href="#">
                            <img className="object-cover" src={items.img} alt="product image" />
                        ...
                        <div className="mt-4 px-5 pb-5">
                            <a href="#">
                                <h5 className="text-xl tracking-tight text-slate-900">{items.title}</h5>
                            </a>
                            ...
                            <a href="#" className="flex items-center justify-center rounded-md bg-purple-600 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-purple-800 focus:outline-none focus:ring-4 focus:ring-blue-300">
