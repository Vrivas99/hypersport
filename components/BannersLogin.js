          ...
          <form  /* onSubmit={handleSumbit()} */ className='mt-6' action='#' method='POST'>
            ...
            <div>
              ...
              <input type='email' placeholder='Ingresa tu correo electronico' 
                className='w-full bg-gray-200 mt-2 border focus:border-blue-500 focus:bg-white focus:outline-none rounded-lg px-4 py-2'
            ...
            <button className='w-full block bg-blue-500 hover:bg-blue-400 px-4 py-3 mt-6 rounded-lg font-semibold text-white focus:bg-blue-400' type="submit">Ingresar</button>

            <hr className='my-6 border-gray-300 w-full'></hr>

            <div className='text-center mt-2'>
              <a href='registro' className='text-sm font-semibold text-gray-700 hover:text-blue-700'>¿No tienes cuenta? Registrate Aqui!</a>
            </div>
