    ...
    <div>
            <form onSubmit={agregarValor} method="POST" className='w-full max-w-lg"'>
                ...
                <div className='items-center'>
                    ...
                    <button onClick={lockData} className='mt-10 ml-3 flex float-right justify-center cursor-pointer bg-green-600 hover:bg-green-900 text-white px-6 py-2 rounded-md font-sans' type='submite'>Agregar</button>
                </div>
            </form>
