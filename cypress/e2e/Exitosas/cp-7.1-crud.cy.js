...
describe('Modificar un producto con campos vacios', () => {
    it('passes', () => {
        ...
        cy.contains('El campo Nombre Producto es obligatorio').should('be.visible')
        ...
        cy.contains('El campo Precio es obligatorio').should('be.visible')

        cy.contains('El campo Descuento es obligatorio').should('be.visible')

        cy.contains('El campo Stock es obligatorio').should('be.visible')
    })
})